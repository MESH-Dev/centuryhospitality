...
add_image_size('fixed-thumbnail', 120, 80, true); //Fixed thumbnail size for the coming soon list
...
function register_city_tax() {
            ...
            register_taxonomy('city', $pages, $args);
        }
        add_action('init', 'register_city_tax');

function register_hotel_family_tax() {
            $labels = array(
                'name'                  => _x( 'Hotel Family', 'taxonomy general name' ),
                'singular_name'         => _x( 'Hotel Family', 'taxonomy singular name' ),
                'add_new'               => _x( 'Add New Hotel Family', 'Hotel Family'),
                'add_new_item'          => __( 'Add New Hotel Family' ),
                'edit_item'             => __( 'Edit Hotel Family' ),
                'new_item'              => __( 'New Hotel Family' ),
                'view_item'             => __( 'View Hotel Family' ),
                'search_items'          => __( 'Search Hotel Family' ),
                'not_found'             => __( 'No Hotel Family found' ),
            ...
            $args = array(
                'labels'            => $labels,
                'singular_label'    => __('Hotel Family'),
                'public'            => true,
                'show_ui'           => true,
                'hierarchical'      => true,
                'show_tagcloud'     => false,
                'show_in_nav_menus' => true,
                'rewrite'           => array('slug' => 'hotel_family', 'with_front' => false ),
             );
            register_taxonomy('hotel_family', $pages, $args);
        }
        add_action('init', 'register_hotel_family_tax');
